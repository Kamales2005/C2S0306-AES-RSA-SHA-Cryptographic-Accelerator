...
# Generated on: Mon Jul 27 12:14:49 IST 2026 (Mon Jul 27 06:44:49 UTC 2026)
...
set_verification_information fv_map_C2S0306_incrementalv_db

read_implementation_information fv/C2S0306 -golden fv_map -revised C2S0306_incrementalv
...
read_design -verilog95   -golden -lastmod -noelab fv/C2S0306/fv_map.v.gz
elaborate_design -golden -root {C2S0306}

read_design -verilog95   -revised -lastmod -noelab ./C2S0306_incremental.v
elaborate_design -revised -root {C2S0306}

#add_name_alias fv/C2S0306/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/C2S0306/C2S0306_incrementalv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles intermediate2final.lec.log
}
